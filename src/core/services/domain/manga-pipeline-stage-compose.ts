...
import type { Scene, SubtitleTrack } from '@/core/services/video/ffmpeg-wasm.service';
 ...
 *   - volume = 1.0
 */
export function buildVideoScenesFromPipeline(pipelineScenes: PipelineScene[]): Scene[] {
