...
describe('ProjectImportExportService', () => {
  ...
  describe('exportProject', () => {
    it('should return filename and content for JSON format', async () => {
      ...
      expect(result.filename).toMatch(/^storyweaver_测试项目_\d{4}-\d{2}-\d{2}\.json$/);
  ...
  describe('backupProject', () => {
    ...
    it('should store backup in localStorage', async () => {
      ...
      const backupContent = localStorage.getItem('storyweaver_backup_mock-uuid-1');
  ...
  describe('restoreBackup', () => {
    ...
    it('should return null for corrupted backup data', async () => {
      localStorage.setItem('storyweaver_backup_corrupted', 'not valid json {');
  ...
  describe('deleteBackup', () => {
    it('should remove backup from localStorage', async () => {
      ...
      expect(localStorage.getItem('storyweaver_backup_mock-uuid-1')).toBeNull();
    });
